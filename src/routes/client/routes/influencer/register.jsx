...
import { Input } from'@client/modules/auth/components/Input'
...
export const action = async ({request}) => {
  ...
  const result = await Auth.influencer.register({data})

  if (result.errors) {
    return json(result)
  }

  return await Auth.influencer.createSession({id: result.id, redirectTo})
}
