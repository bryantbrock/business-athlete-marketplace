...
import {useParentLoaderData} from '@client/utils/hooks'
import {updateInquiry} from '@client/modules/inquiry/actions.server'
...
export const action = async ({request, params}) => {
  ...
  return redirect(`/influencer/inquiries/${inquiryId}`)
}
